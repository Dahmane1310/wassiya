...
/** "Continue with Google / Apple" — provider-direct starts via /auth/oauth. */
export function OAuthButtons({ returnTo }: { returnTo: string }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      <a className="press" href={href("google")} style={base}>
      ...
      <a className="press" href={href("apple")} style={base}>
